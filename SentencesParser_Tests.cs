...
namespace TextAnalysis
{
    ...
    public class SentencesParser_Tests
    {
        [Test]
        [Order(00)]
        public void ReturnCorrectResult_OnTextWithOneSentenceWithOneWord() // с одним словом
        {
            var text = "abc";
        ...
        [Test]
        [Order(30)]
        public void CorrectlyParse_SentenceDelimiters() // Правильно разбирать разделители предложений
        {
        ...
        [Test]
        [Order(40)]
        public void CorrectlyParse_SpecialCharacters() // Правильно анализировать специальные символы
        {
        ...
        public void CorrectlyParse_OneSentenceWithWordDelimiter(
            [Values('^', '#', '$', '-', '+', '1', '=', ' ', '\t', '\n', '\r')] char delimiter) // одно предложение с разделителем слов
        {
        ...
        [Test]
        [Order(60)]
        public void IgnoreLeadingAndTrailingSpaces() // Игнорировать начальные и конечные пробелы
        {
            var text = " B . C";
            var expected = new List<List<string>>
            {
